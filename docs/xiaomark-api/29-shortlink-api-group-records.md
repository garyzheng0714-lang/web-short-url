...
- Source: https://xiaomark.com/help/api/shortlink-api-group-records
- Fetched: 2026-02-24 17:14:31 +0800

## 接口功能

获取某个短链分组下的全部[短链接](https://xiaomark.com/shortlink)的一年之内的访问记录。

## 接口地址

```
https://api.xiaomark.com/v2/sl/group/visit_record/batch_get
```
