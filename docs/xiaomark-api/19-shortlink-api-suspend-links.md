...
- Source: https://xiaomark.com/help/api/shortlink-api-suspend-links
- Fetched: 2026-02-24 17:14:27 +0800

## 接口功能

传入[短链接](https://xiaomark.com/shortlink)列表，调用此接口后可以暂停这些短链接的跳转（显示404页面）。

## 接口地址

```
https://api.xiaomark.com/v2/sl/link/batch_suspend
```
