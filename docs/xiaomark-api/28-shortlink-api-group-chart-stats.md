...
- Source: https://xiaomark.com/help/api/shortlink-api-group-chart-stats
- Fetched: 2026-02-24 17:14:31 +0800

## 接口功能

获取某个短链分组的多维度统计数据，对应数据报表中的24小时分布、地理位置分布、设备占比等数据。

## 接口地址

```
https://api.xiaomark.com/v2/sl/group/chart_stats/get
```
...
| visit\_count | integer | 访问次数 |
| visitor\_count | integer | 访问人数 |
| ip\_count | integer | 访问IP数 |
| visited\_link\_count | integer | 被访问短链数 |
| created\_link\_count | integer | 创建短链数 |
